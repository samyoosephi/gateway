...
class GatewayServiceProvider extends ServiceProvider
{
    ...
    private function getProvider()
    {
        if (version_compare(\Illuminate\Foundation\Application::VERSION, '5.0', '<')) {
            $provider = 'Samyoosephi\Gateway\GatewayServiceProviderLaravel4';
            ...
            $provider = 'Samyoosephi\Gateway\GatewayServiceProviderLaravel5';
        }else {
            $provider = 'Samyoosephi\Gateway\GatewayServiceProviderLaravel6';
        }
